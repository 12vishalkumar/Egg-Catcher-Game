...
score = 0
score_text = c.create_text(10, 10, anchor="nw" , font=("Arial", 18, "bold"), fill="darkblue",text="Your Score : " + str(score))
lives_remaning = 3
...
def egg_dropped(egg):
    ...
    lose_a_life()
    if(lives_remaning == 0):
        messagebox.showinfo("GAME IS OVER!", "Your Final Score : " + str(score))
        win.destroy()
